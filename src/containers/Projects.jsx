...
import ai from "../assets/ai-summarize.png";
  ...
  return (
    <div className="projects" id="projects">
      ...
      <div className="project-list" data-aos="fade-up" data-aos-delay="800">
        ...
        <ProjectItem
          name="AI - Summarizer"
          description="Summize is an innovative web application designed to simplify your reading experience by transforming lengthy articles into clear and concise summaries. Built with modern web development technologies, Summize leverages the power of AI to provide users with quick and accurate summaries, making it easier to grasp the essence of any article in seconds.

          "
          url="https://ai-summarizer-ten-eta.vercel.app"
          image={ai}
        />
      </div>
    </div>
